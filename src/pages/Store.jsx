  ...
  useEffect(() => {
    const fetchStore = async () => {
      const response = await axios({
        url: `https://iotmarket.herokuapp.com/api/v1/store/${path}`,
        method: 'get',
      });
    ...
    const fetchProducts = async () => {
      const response = await axios({
        url: `https://iotmarket.herokuapp.com/api/v1/product/user/${path}`,
        method: 'get',
      });
    ...
    const fetchOrders = async () => {
      const response = await axios({
        url: `https://iotmarket.herokuapp.com/api/v1/order/store/${path}`,
        method: 'get',
        headers: {
